...
| `icon.svg` | SVG-фавикон: метка на фирменной тёмной плитке, как в приложении |
| `favicon-48.png` | Та же плитка PNG 48×48 для Google Search |
| `apple-touch-icon.png` | Та же плитка 180×180 для Home Screen |
| `icon-192.png` | Та же плитка 192×192 для JSON-LD `logo` |
| `logo.svg` | Метка без плитки для мокапа окна на главной |
