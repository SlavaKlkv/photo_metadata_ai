...
| `icon.svg` | Исходник иконки приложения (метка на плитке), в фавикон не идёт |
| `favicon-48.png` | Прозрачная метка PNG 48×48 для Google Search, без desktop-плитки |
| `apple-touch-icon.png` | Прозрачная метка 180×180 для Home Screen |
| `icon-192.png` | Прозрачная метка 192×192 для JSON-LD `logo` |
| `logo.svg` | Метка без плитки: мокап окна на главной и SVG-фавикон |
