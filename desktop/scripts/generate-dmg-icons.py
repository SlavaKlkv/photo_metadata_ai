...
# Стрелка заполняет увеличенный промежуток между основными иконками,
# не приближаясь к ним вплотную.
ARROW_WIDTH_PT = 120
HINT_WIDTH_PT = 480  # подсказка использует ширину окна, сохраняя поля
