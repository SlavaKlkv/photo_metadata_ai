...
> [!IMPORTANT]
> На актуальных версиях macOS ни один GUI-обход не работает. Проверено на образе,
> скачанном из релиза: двойной клик из панели загрузок не даёт ничего, правый клик →
> **Открыть** не помогает, **Открыть всё равно** в настройках безопасности до `.dmg`
> не доходит. С `.zip` ровно то же самое — карантин наследуется распакованному бандлу.
>
